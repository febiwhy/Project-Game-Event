...
<head>
    ...
    <title>Data Article - Loop Tourney</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="hero-banner">
                ...
                <div class="hero-content">
                    ...
                    <h1 class="hero-title">Data Article</h1>
                    <p class="hero-subtitle">Kelola semua artikel platform Loop Tourney</p>
                </div>
            </div>
            ...
            <div class="content pt-0">
                ...
                <div class="alert alert-custom alert-styled-left alert-arrow-left alert-dismissible">
                    ...
                    <div class="d-flex align-items-center">
                        <i class="icon-newspaper mr-3" style="font-size: 1.5rem;"></i>
                        <div>
                            <strong>Article Management:</strong> Kelola semua konten artikel dan berita platform
                        </div>
                    </div>
                </div>
                <!-- /info alert -->
                ...
                <div class="dashboard-card scroll-animate">
                    <div class="card-header">
                        ...
                        <div class="header-elements">
                            <div class="list-icons">
                                ...
                                <a class="list-icons-item" data-action="reload" onclick="$('#article').DataTable().ajax.reload();"></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            <a href="{{ route('article.create') }}" class="btn btn-purple">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" id="article">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Judul</th>
                ...
                columns: [
                    ...
                    { 
                        ...
                        render: function(data, type, full, meta) {
                            return data || `
                                <div class="btn-group">
                                    <a href="/article/${full.id}/edit" class="btn btn-warning btn-sm">
