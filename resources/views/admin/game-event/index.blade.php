	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content pt-0">
				...
				<div class="card" >
					<div class="card-header header-elements-inline">
						<h2 class="card-title">Data Turnamaent Event </h2>
						<div class="header-elements">
							<div class="list-icons">
							<div class="col-md-3 col-sm-4">
								<div class="d-flex align-items-center">
									<a href="{{ route('game-event.create') }}" class="text-white">
									<i class="icon-file-plus mr-4 icon-2x"></i>
									</a>
								</div>
							</div>
								<a class="list-icons-item" data-action="collapse"></a>
				...
				<div class="container mr-4">
					{{-- <a href="{{ route('game-event.create') }}" class="btn btn-purple btn-sm fw-bold mb-3" 
								...
								@if ($game_events)
									@foreach ($game_events as $game_event)
										<tr>
											...
											<td>{{ $game_event->name }}</td>
											<td>
												<img src="{{ asset($game_event->thumbnail) }}" alt="" height="50px" width="50px">
											</td>
											<td>{{ $game_event->description }}</td>
											<td class="text-center">
												<div class="d-flex justify-content-center">
													<!-- Tombol Show -->
													<a href="{{ route('game-event.show', $game_event->id) }}" class="btn btn-primary btn-sm me-2">
														<i class="fas fa-eye"></i>
													</a>

													<!-- Tombol Edit -->
													<a href="{{ route('game-event.edit', $game_event->id) }}" class="btn btn-success btn-sm me-2">
														<i class="fas fa-edit"></i>
													</a>

													<!-- Tombol Hapus -->
													<form action="{{ route('game-event.destroy', $game_event->id) }}" method="POST" id="delete-form-{{ $game_event->id }}">
														@csrf
														@method('DELETE')
														<a href="javascript:void(0);" 
															class="btn btn-danger btn-sm" 
															onclick="confirmDelete('{{ $game_event->id }}')">
