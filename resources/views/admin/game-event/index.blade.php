			...
			<div class="page-header border-bottom-0">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Halaman</span> - Game Turnament</h4>
			...
			<div class="content pt-0">
				...
				<div class="container mr-4" id="right-icon-tab1">
					<div class="table-responsive">
						...
						<table class="table table-striped table-bordered" style="background-color: #3e414d; color: #ffffff;" id="game-table">
			...
			$(document).ready(function() {
				$('#game-table').DataTable({
					...
					initComplete: function() {
						...
						$('#game-table tbody tr').css({
							'background-color': '#3e414d',
							'color': '#ffffff'
						});

						$('#game-table thead').css({
