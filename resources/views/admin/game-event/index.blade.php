        ...
        <div class="content-wrapper">
            ...
            <div class="hero-banner">
                ...
                <div class="hero-content">
                    ...
                    <h1 class="hero-title">Game Tournament</h1>
                    <p class="hero-subtitle">Kelola semua turnamen game di platform Loop Tourney</p>
                </div>
            </div>
            ...
            <div class="content pt-0">
                ...
                <div class="alert alert-custom alert-styled-left alert-arrow-left alert-dismissible">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <strong>Tournament Management:</strong> Kelola semua turnamen game dan kompetisi platform
                        </div>
                    </div>
                </div>
                <!-- /info alert -->
                ...
                <div class="dashboard-card scroll-animate">
                    <div class="card-header">
                        <h2 class="card-title">
                            ...
                            Data Tournament Event
                        </h2>
                        <div class="header-elements">
                            <div class="list-icons">
                                <a class="list-icons-item" data-action="collapse"></a>
                                <a class="list-icons-item" data-action="reload" onclick="$('#game-table').DataTable().ajax.reload();"></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            <a href="{{ route('game-event.create') }}" class="btn btn-purple">
                                <i class="icon-plus22 mr-2"></i>
                                Tambah Game Tournament
                            </a>
                        </div>

                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" id="game-table">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama Game</th>
                ...
                columns: [
                    ...
                    { 
                        ...
                        render: function(data, type, full, meta) {
                            return data || `
                                <div class="btn-group">
                                    <a href="/game-event/${full.id}/edit" class="btn btn-warning btn-sm">
