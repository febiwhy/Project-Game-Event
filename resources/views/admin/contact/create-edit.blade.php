			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="{{route('contact.index')}}" class="nav-link"><i class="icon-enter5 mr-3 mr-3"></i> <span>Kembali</span></a>
						</li>
						<!-- /main -->
					</ul>
				</div>
				...
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4> <img src="{{ asset('global_assets/images/logo.png') }}" alt="Logo" style="height: 35px; width: auto; display: inline-block; vertical-align: middle;"> 
							<span class="font-weight-semibold">Halaman</span> {{ isset($contact) ? 'Edit Game Event' : 'Tambah Game Event' }}
						</h4>
										...
										<form action="{{ isset($game_event) ? route('game-event.update', $game_event->id) : route('game-event.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            @endif
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" name="organizer" id="organizer" value="{{ old('telepon', $contact->telepon ?? '') }}" placeholder="Massukan Nomor Telepon" required>
