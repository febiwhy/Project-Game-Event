...
<head>
    ...
    <title>{{ isset($contact) ? 'Edit Kontak' : 'Tambah Kontak' }} - Loop Tourney</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="hero-banner">
                ...
                <div class="hero-content">
                    ...
                    <h1 class="hero-title">{{ isset($contact) ? 'Edit Kontak' : 'Tambah Kontak' }}</h1>
                    <p class="hero-subtitle">Kelola informasi kontak platform Loop Tourney</p>
                </div>
            </div>
            ...
            <div class="content pt-0">
                ...
                <div class="alert alert-custom alert-styled-left alert-arrow-left alert-dismissible">
                    ...
                    <div class="d-flex align-items-center">
                        <i class="icon-address-book mr-3" style="font-size: 1.5rem;"></i>
                        <div>
                            <strong>Contact Management:</strong> Kelola informasi kontak dan lokasi platform
                        </div>
                    </div>
                </div>
                <!-- /info alert -->
                ...
                <div class="dashboard-card scroll-animate">
                    <div class="card-header">
                        <h2 class="card-title">
                            ...
                            Form {{ isset($contact) ? 'Edit' : 'Tambah' }} Kontak
                        </h2>
                            ...
                            <div class="col-md-10 offset-md-1">
                                ...
                                <form action="{{ isset($contact) ? route('contact.update', $contact->id) : route('contact.store') }}" method="POST" enctype="multipart/form-data" id="form-contact">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="location" id="location" value="{{ old('location', $contact->location ?? '') }}" placeholder="Masukkan lokasi" required>
                                        @error('location') <p class="error-message">{{ $message }}</p> @enderror
                                    </div>

                                    <div class="form-group">
                                        <label for="telepon">Nomor Telepon :</label>
                                        <input type="text" class="form-control" name="telepon" id="telepon" value="{{ old('telepon', $contact->telepon ?? '') }}" placeholder="Masukkan nomor telepon" required>
                                        @error('telepon') <p class="error-message">{{ $message }}</p> @enderror
                                    </div>

                                    <div class="form-group">
                                        <label for="email">Email :</label>
                                        <input type="email" class="form-control" name="email" id="email" value="{{ old('email', $contact->email ?? '') }}" placeholder="Masukkan email" required>
                                        @error('email') <p class="error-message">{{ $message }}</p> @enderror
                                    </div>

                                    <div class="text-right mt-4">
                                        <a href="{{ route('contact.index') }}" class="btn btn-light mr-2">
                                            <i class="icon-arrow-left13 mr-2"></i> Kembali
                                        </a>
                                        <button type="submit" class="btn btn-purple">
                                            <i class="icon-paperplane mr-2"></i> {{ isset($contact) ? 'Perbarui' : 'Simpan' }}
                                        </button>
                                    </div>
                                </form>
                            </div>
