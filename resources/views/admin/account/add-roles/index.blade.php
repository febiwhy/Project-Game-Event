				...
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4> <img src="{{ asset('global_assets/images/logo.png') }}" alt="Logo" style="height: 35px; width: auto; display: inline-block; vertical-align: middle;"> 
							<span class="font-weight-semibold">Halaman</span> - Data Role </h4>
			    ...
			    <!-- /info alert -->
						...
						<div class="card fade-in">
							<div class="card-header header-elements-inline">
								<h2 class="card-title"> Data Roles</h2>
								...
								<div class="container mr-4" id="right-icon-tab1">
									<div class="table-responsive">
										<div class="btn-group">
											<button type="button" class="btn bg-indigo-400" onclick="location.href='{{ route('roles.create') }}'"><i class="icon-plus22 mr-3"></i> Tambah Role </button>
										</div>
										<div class="container p-4">
											<table class="table table-striped table-bordered" style="background-color: #3e414d; color: #ffffff;" id="roles-table">
			...
			$(document).ready(function() {
				$('#roles-table').DataTable({
					...
					initComplete: function() {
						...
						$('#roles-table tbody tr').css({
							'background-color': '#3e414d',
							'color': '#ffffff'
						});

						$('#roles-table thead').css({
