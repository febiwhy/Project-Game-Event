...
<head>
    ...
    <title>Admin Detail - Loop Tourney</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="hero-banner">
                ...
                <div class="hero-content">
                    ...
                    <h1 class="hero-title">Detail Akun</h1>
                    <p class="hero-subtitle">Informasi lengkap tentang akun pengguna</p>
                </div>
            </div>
            ...
            <div class="content pt-0">
                ...
                <div class="alert alert-custom alert-styled-left alert-arrow-left alert-dismissible">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <strong>Detail Akun:</strong> Lihat informasi lengkap tentang akun pengguna
                        </div>
                    </div>
                </div>
                <!-- /info alert -->
                ...
                <div class="detail-card scroll-animate">
                    ...
                    <div class="card-body">
                        <table class="detail-table">
                            ...
                            <tr>
                                <th>Status</th>
                                <td>{{ $users->status ?? 'Tidak tersedia' }}</td>
                            </tr>
                            <tr>
                                <th>Bukti Pembayaran</th>
                                <td>
                                    @if (!empty($users->payment_proof))
                                        <img src="{{ asset($users->payment_proof) }}" alt="payment_proof" class="payment-proof">
                                    @else
                ...
                <div class="dashboard-card scroll-animate">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('account.index') }}" class="btn btn-purple">
