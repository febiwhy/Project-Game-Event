			...
			<div class="page-header border-bottom-0">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4> <img src="{{ asset('global_assets/images/logo.png') }}" alt="Logo" style="height: 35px; width: auto; display: inline-block; vertical-align: middle;"> <span class="font-weight-semibold">Halaman</span> {{ isset($game_event_follower) ? 'Edit Komunitas' : 'Tambah Komunitas Baru' }}</h4>
							...
							<div class="card-header header-elements-inline">
								...
								<div class="card-body">
									<div class="row">
										...
										<form action="{{ @$game_event_follower->id ? route('event-community.update', @$game_event_follower->id) : route('event-community.store') }}" method="POST" id="form-community" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            @endif
												...
												<div class="form-group">
													<label for="name_community">Nama Komunitas :</label>
													<input type="text" class="form-control" name="name_community" id="name_community" value="{{ old('name_community', @$game_event_follower->name_community) }}" placeholder="Massukan Nama Komunitas" required>
												</div>

												<div class="form-group">
													<label for="platform">Nama Platform :</label>
													<input type="text" class="form-control" name="platform" id="platform" value="{{ old('platform', @$game_event_follower->platform) }}" placeholder="Massukan Platform" required>
												</div>
												
												<div class="form-group">
													<label for="description">Deskripsi Komunitas :</label>
													<textarea rows="5" cols="5" class="form-control" name="description" id="description" placeholder="Massukan description">{{ old('description', @$game_event_follower->description) }}</textarea>
												</div>
